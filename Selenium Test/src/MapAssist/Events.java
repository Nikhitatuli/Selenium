...
class EventHandler implements WebDriverEventListener{
	 public void afterClickOn(WebElement CTA,WebDriver driver) 
     {
...
eventHandler.navigate().to("https://mapsassist.com");
eventHandler.findElement(By.xpath("//*[@id=\"get-directions\"]")).click();
Thread.sleep(30000);
	driver.close();
}
}
